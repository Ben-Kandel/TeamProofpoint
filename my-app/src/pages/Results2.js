...
class Model extends React.Component{
    ...
    getTrumpEmails(){
        fetch("http://127.0.0.1:8000/api/consumers/?keywords=Trump", this.requestOptions)
    ...
    getBidenEmails(){
        fetch("http://127.0.0.1:8000/api/consumers/?keywords=Biden", this.requestOptions)
        .then(response => response.json())
        .then(result => {
            this.setState({
    ...
    getPosTrumpEmails(){
        fetch("http://127.0.0.1:8000/api/consumers/?keywords=Trump&pn=Positive", this.requestOptions)
        .then(response => response.json())
        .then(result => {
            this.setState({
    ...
    getNegTrumpEmails(){
        fetch("http://127.0.0.1:8000/api/consumers/?keywords=Trump&pn=Negative", this.requestOptions)
        .then(response => response.json())
        .then(result => {
            this.setState({
    ...
    getPosBidenEmails(){
        fetch("http://127.0.0.1:8000/api/consumers/?keywords=Biden&pn=Positive", this.requestOptions)
        .then(response => response.json())
        .then(result => {
            this.setState({
    ...
    getNegBidenEmails(){
        fetch("http://127.0.0.1:8000/api/consumers/?keywords=Biden&pn=Negative", this.requestOptions)
        .then(response => response.json())
        .then(result => {
            this.setState({
    ...
    getGraphData() { //Our data structure is a Map of Maps. The nested Map is the Value of the 4 keys of the first map.
        ...
        fetch("http://127.0.0.1:8000/api/consumers/" , this.requestOptions)
            .then(response => response.json())
            .then(result => {
            let dateMap = new Map();
